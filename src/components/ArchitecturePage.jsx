...
const subcategories = [
    {
        ...
        description: 'Bespoke homes and luxury living spaces.'
    },
    {
        id: 'Commercial',
        title: 'Commercial',
        image: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200',
        description: 'Modern office spaces and retail environments.'
    },
    {
        id: 'Hospitality',
        title: 'Hospitality',
        image: 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?q=80&w=1200',
        description: 'World-class hotels, resorts, and restaurants.'
    },
    {
        id: 'Institutional',
        title: 'Institutional',
        image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=1200',
        description: 'Public buildings, schools, and cultural spaces.'
    }
];
                    ...
                    {!selectedCategory ? (
                        ...
                        >
                            <div className="mb-16">
                                ...
                                <p className="text-lush-dark/70 font-inter font-light max-w-2xl text-base sm:text-lg">
                                    Exploring structural elegance and spatial harmony through modern architectural design. Select a category to explore our projects.
                                </p>
                            </div>
                        ...
                        >
                            <div className="mb-12">
                                ...
                                <p className="text-lush-dark/70 font-inter font-light max-w-2xl text-base sm:text-lg">
                                    Showing our {selectedCategory.toLowerCase()} architectural projects.
                                </p>
                            </div>
